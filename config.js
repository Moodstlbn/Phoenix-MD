...
module.exports = {
  ...
  BRANCH: "main",
  //_________________________________________________________________________________________________________________________________
  SESSION_ID: process.env.SESSION_ID || "Phoenix~HvTQJHKH", //Enter Your Session Id Here
  //_________________________________________________________________________________________________________________________________
  ...
  //_________________________________________________________________________________________________________________________________
  STICKER_DATA: "🎯𝙿𝚑𝚘𝚎𝚗𝚒𝚡-𝙼𝙳;moods.ink☘️",
  //_________________________________________________________________________________________________________________________________
  ...
  //_________________________________________________________________________________________________________________________________
  OWNER_NAME: process.env.OWNER_NAME || "moods.ink",
  //_________________________________________________________________________________________________________________________________
